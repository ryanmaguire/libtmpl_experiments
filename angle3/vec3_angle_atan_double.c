...
{
    tmpl_ThreeVectorDouble cross = tmpl_3DDouble_Cross_Product(P, Q);
    double norm_cross = tmpl_3DDouble_L2_Norm(&cross);
    double dot = tmpl_3DDouble_Dot_Product(P, Q);
    return tmpl_Double_Arctan2(norm_cross, dot);
}
/*  End of Angle_Vec3_Arctan.                                                 */
