...
static void
merge(double *out, const double * const LA, const double * const LB,
...
static double *merge_sort(double * const arr, unsigned int arr_length)
{
