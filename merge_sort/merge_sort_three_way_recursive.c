...
static unsigned int floor_int(double x)
{
    const double floor_x = floor(x);
    return (unsigned int)floor_x;
}

/*  Function for determining if an integer is a power of 3. This may get used *
 *  later for plotting.                                                       */
static boolean Is_Power_Of_Three(unsigned int n)
{
...
static double x_log_x(double x)
{
 ...
 *  respectively.                                                             */
static void
merge(double * const out, const double * const LA, const double * const LB,
      const double * const LC, unsigned int a, unsigned int b, unsigned int c)
{
...
static double *merge_sort(double * const 
arr, unsigned int arr_length)
{
    ...
    a = floor_int(0.3334 * arr_length);
    b = floor_int(0.3334 * arr_length);
    c = arr_length - (a + b);
