 ...
 ******************************************************************************/
#ifndef TMPL_EXPERIMENTS_KAUFFMAN_H
#define TMPL_EXPERIMENTS_KAUFFMAN_H
...
#define POSITIVE_CROSSING (0x00U)
#define NEGATIVE_CROSSING (0x01U)

/*  Crossing type for the Gauss code. Is the current strand over or under.    */
typedef unsigned char crossing_type;
#define OVER_CROSSING (0x00U)
#define UNDER_CROSSING (0x01U)
