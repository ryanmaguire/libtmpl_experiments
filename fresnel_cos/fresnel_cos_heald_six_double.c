 ...
 *  Error bounded by 10^-6.                                                   *
 ******************************************************************************/
#define A0 (+1.0000000000000000E+00)
#define A1 (+8.2180000000000000E-02)
#define A2 (+1.5108000000000000E-01)
#define B0 (+2.0000000000000000E+00)
#define B1 (+2.7097000000000000E+00)
#define B2 (+2.3185000000000000E+00)
#define B3 (+1.2389000000000000E+00)
#define B4 (+6.5610000000000000E-01)
#define C0 (+1.0000000000000000E+00)
#define C1 (+6.0427000000000000E-01)
#define C2 (+4.1159000000000000E-01)
#define C3 (+1.9170000000000000E-01)
#define D0 (+1.4142135623730951E+00)
#define D1 (+2.2679400000000000E+00)
#define D2 (+2.1559400000000000E+00)
#define D3 (+1.2605700000000000E+00)
#define D4 (+6.0353000000000000E-01)
...
double Fresnel_Cos_Double_Heald_Six(double x)
{
    ...
    const double a = A0 + arg*(A1 + arg*A2);

    /* Compute the Denominator of the A_jk Function.                          */
    const double b = B0 + arg*(B1 + arg*(B2 + arg*(B3 + arg*B4)));

    /* Compute the Numerator of the R_lm Function.                            */
    const double c = C0 + arg*(C1 + arg*(C2 + arg*C3));

    /* Compute the Denominator of the R_lm Function.                          */
    const double d = D0 + arg*(D1 + arg*(D2 + arg*(D3 + arg*D4)));
