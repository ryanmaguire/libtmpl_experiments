 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Slight modification of the descending floor algorithm. Here, we check *
 *      the value of dx against the powers in the table, adding if necessary. *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       June 21, 2024                                                 *
 ******************************************************************************/
...
static double my_floor(double x)
{
    ...
    while (dx > 1.0)
    {
        ...
        /*  If |x| - out > 2^n, we can add 2^n to "out".                      */
        if (dx > arr[n])
            out += arr[n];
